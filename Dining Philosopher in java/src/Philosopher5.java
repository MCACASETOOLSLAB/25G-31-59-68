 ...
 * @author savita
 */
public class Philosopher5 extends Thread{  private static final int MAX_EATING_TIME = 1000;
    private static final int MAX_THINKING_TIME = 800;
    private final Random randomise = new Random();
    private final Chopstick5 _leftChopstick;
    private final Chopstick5 _rightChopstick;
    ...
    * 
    */
    public Philosopher5(String name, Chopstick5 leftChopstick, Chopstick5 rightChopstick) {
    ...
    */
    private void eat() throws InterruptedException {
        ...
        while(_leftChopstick.isUsed() || _rightChopstick.isUsed()) {
                try{
                    this.setPhilosopherState(Philosopher5.State.WAITING);
                    _leftChopstick.wait();
                ...
                try{
                    ...
                    this.setPhilosopherState(Philosopher5.State.EATING);
    ...
    */
    private void think() throws InterruptedException{
        this.setPhilosopherState(Philosopher5.State.THINKING);
